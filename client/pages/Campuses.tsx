...
export default function Campuses() {
  const [campuses, setCampuses] = useState<Campus[]>([
    { id: "c-1", name: "Main Campus", code: "MAIN", city: "Karachi", address: "Shahrah-e-Faisal", status: "active" },
    { id: "c-2", name: "North Campus", code: "NTH", city: "Lahore", address: "DHA", status: "suspended" },
  ]);
  const [selectedId, setSelectedId] = useState<string>(campuses[0]?.id || "");

  const selected = useMemo(() => campuses.find((c) => c.id === selectedId) || campuses[0], [campuses, selectedId]);
            ...
            <CardContent>
              ...
              >
                <div className="space-y-1.5">
                  ...
                  <Input id="name" name="name" required placeholder="e.g., City Campus" />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="code">Code</Label>
                  <Input id="code" name="code" required placeholder="e.g., CC" />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  ...
                  <Input id="address" name="address" placeholder="Street and area" />
                </div>
              ...
              {selected && (
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input id="m-code" name="code" defaultValue={selected.code} required />
                  </div>
                  <div className="space-y-1.5">
                    <Label>City</Label>
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    ...
                    <Input id="m-address" name="address" defaultValue={selected.address} />
                  </div>
                  ...
                  {suspended.map((c) => (
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="text-right">
                        <Button size="sm" onClick={() => setStatus(c.id, "active")}>Activate</Button>
                      </TableCell>
                    </TableRow>
                  ))}
                  {!suspended.length && (
                    <TableRow>
                      <TableCell colSpan={5} className="text-center text-muted-foreground">No suspended campuses.</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
